...
class Deck:
    ...
    """
    def __init__(self):
        print("Crating New Ordered Deck!")
...
# Create new deck and split it in split_in_half
d = Deck()
d.shuffle()
...
user = Player("Surendra", Hand(half2))
...
while user.still_has_cards() and comp.still_has_cards():
    ...
    if c_card[1] == p_card[1]:
        ...
        if RANKS.index(c_cards[1]) < RANKS.index(p_card[1]):
